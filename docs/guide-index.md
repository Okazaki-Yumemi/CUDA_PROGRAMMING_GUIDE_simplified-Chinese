...
<div class="status-grid">
  ...
  <div class="status-card"><h3>逐段翻译</h3><p>第一部分 1.1–1.3、第二部分 2.1–2.7 与第三部分 3.1–3.5 已和官方网页逐段核对；第四至第六部分按章节继续推进。</p></div>
  <div class="status-card"><h3>图版</h3><p>原 PDF 图 1–23 已保留页码并附中文解释，第三部分另保留 PDL 原图示，章节正文同时使用官方图示资源。</p></div>
  <div class="status-card"><h3>版本核对</h3><p>保留 Release 13.3 和官方在线目录入口，方便发现后续版本差异。</p></div>
</div>

<div class="translation-note">
  <strong>阅读边界：</strong>第一至第三部分已完成逐段翻译，第四至第六部分仍按章节推进；未完成页面不会把摘要标成全文翻译。代码标识符、API 名称、公式和版本限制尽量保持原文；涉及生产环境或新硬件时，请将本文与官方文档并读。
</div>

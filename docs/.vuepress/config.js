  ...
  '/05-technical-appendices/': [
    {
      ...
      children: [
        { text: '5.1 计算能力（Compute Capabilities）', link: '/05-technical-appendices/compute-capabilities.html' },
        { text: '5.2 CUDA 环境变量（CUDA Environment Variables）', link: '/05-technical-appendices/environment-variables.html' },
        { text: '5.3 C++ 语言支持（C++ Language Support）', link: '/05-technical-appendices/cpp-language-support.html' },
        { text: '5.4 C/C++ 语言扩展（C/C++ Language Extensions）', link: '/05-technical-appendices/cpp-language-extensions.html' },
        { text: '5.5 浮点计算（Floating-Point Computation）', link: '/05-technical-appendices/floating-point-computation.html' },
        { text: '5.6 设备可调用 API 与内建函数（Device-Callable APIs and Intrinsics）', link: '/05-technical-appendices/device-callable-apis.html' },
        { text: '5.7 CUDA C++ 内存模型（CUDA C++ Memory Model）', link: '/05-technical-appendices/cuda-memory-model.html' },
        { text: '5.8 CUDA C++ 执行模型（CUDA C++ Execution model）', link: '/05-technical-appendices/cuda-execution-model.html' },
      ],
    },
  ],
  '/06-notices/': [
    {
      text: '6. Notices',
      children: [
        { text: '6.1 声明（Notice）', link: '/06-notices/notice.html' },
        { text: '6.2 OpenCL 声明（OpenCL）', link: '/06-notices/opencl.html' },
        { text: '6.3 商标（Trademarks）', link: '/06-notices/trademarks.html' },
      ],
    },
  ],
  '/': [
